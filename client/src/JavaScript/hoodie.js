...
[...thumnails].forEach((thumbnail, index) => {
  thumbnail.addEventListener("click", () => {
    img_container.children[0].src = `../images/hoodieAssets/image-product-${
      index + 1
    }.png`;
...
modal_next.addEventListener("click", () => {
  if (image_index < 4) {
    modal_thumnails[image_index - 1].removeChild(
      document.querySelector(".modal-img-mask")
    );
    image_index++;
    modal_img_container.children[1].src = `../images/hoodieAssets/image-product-${image_index}.png`;
...
document
  .getElementById("order_placed_modal_close_button")
