...
const About = () => {
  return (
    <>
      ...
      <Navbar></Navbar>
      <div className=" mt-[920px] md:mt-14  flex justify-center place-items-center h-screen">
        <div className="text-white text-center bg-[#0F1016] p-10 rounded-lg  tracking-widest text-xl leading-10 w-[90vw] ">
