  ...
  return (
    <>
      ...
      <div className=" mt-[150px]  md:mt-14  flex justify-center place-items-center h-screen">
        <div className="text-white leading-5 tracking-widest md:text-center bg-[#0F1016] px-5 py-10 md:p-10 flex flex-col rounded-lg text-xs  md:tracking-widest md:text-xl md:leading-10 w-[90vw] ">
          <span className="text-pink-400 font-bold text-4xl mb-5">
            Abhyuday 9.0
          </span>
          <div>
            ...
            Technical fest , Set to launch on{" "}
            <span className="text-pink-400 font-bold">16th May 2025</span> ,
            This year’s edition draws inspiration from the cosmic realm with the
            electrifying theme —{" "}
            <span className="text-pink-400 font-bold">
            ...
            students of MCA and BCA, this one-day extravaganza offers a galaxy
            of opportunities to learn, compete, and connect. From brain-teasing
            challenges like{" "}
            ...
            <span className="text-pink-400 font-bold">
              Abhyuday 9.0 promises an experience that's truly out of this
              world.
            </span>
          </div>
        </div>
